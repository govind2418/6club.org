...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden border-b border-goldline">
      ...
      <div className="relative mx-auto max-w-7xl px-5 pb-14 pt-32 text-center lg:px-8 lg:pt-40 lg:text-left">
        <p className="section-eyebrow">{pageEyebrow ?? '6 Club'}</p>
        <h1 className="text-balance mx-auto mt-4 max-w-2xl text-3xl font-bold text-white lg:mx-0 lg:text-5xl">
          {h1}
        </h1>
